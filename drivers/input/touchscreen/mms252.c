...
#define CORE_VERSION_IJ 0x76
#define FW_VERSION_IJ 0x20

/* EELY panel */
#define BOOT_VERSION_EL 0x1
#define CORE_VERSION_EL 0x76
#define FW_VERSION_EL 0x20
...
static void get_config_ver(void *device_data)
{
	...
	if (info->panel == YONGFAST)
		...
		snprintf(buff, sizeof(buff), "T311_Me_0717_IJ");
	else if (info->panel == EELY)
		snprintf(buff, sizeof(buff), "T311_Me_0717_EL");
	else
		snprintf(buff, sizeof(buff), "T311_Me_0717_UN");
