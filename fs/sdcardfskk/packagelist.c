...
int get_caller_has_rw_locked_kitkat(void *pkgl_id, derive_t derive) {
...
appid_t get_appid_kitkat(void *pkgl_id, const char *app_name)
{
	struct packagelist_data *pkgl_dat = (struct packagelist_data *)pkgl_id;
	struct hashtable_entry *hash_cur;
	struct hlist_node *h_n;
...
int check_caller_access_to_name_kitkat(struct inode *parent_node, const char* name,
 ...
 * checked before calling check_caller_access_to_name_kitkat() */
int open_flags_to_access_mode_kitkat(int open_flags) {
...
void * packagelist_create_kitkat(gid_t write_gid)
{
...
void packagelist_destroy_kitkat(void *pkgl_id)
{
	struct packagelist_data *pkgl_dat = (struct packagelist_data *)pkgl_id;
...
int packagelist_init_kitkat(void)
{
...
void packagelist_exit_kitkat(void)
{
	if (hashtable_entry_cachep)
