 ...
 *          1: dentry is valid
 */
static int sdcardfskk_d_revalidate(struct dentry *dentry, struct nameidata *nd)
{
	int err = 1;
	...
	sdcardfskk_get_lower_path(parent_dentry, &parent_lower_path);
...
out:
	...
	sdcardfskk_put_lower_path(parent_dentry, &parent_lower_path);
 ...
 */
static int sdcardfskk_cmp_ci(const struct dentry *parent,
...
const struct dentry_operations sdcardfskk_ci_dops = {
	.d_revalidate	= sdcardfskk_d_revalidate,
	.d_release	= sdcardfskk_d_release,
	.d_hash 	= sdcardfskk_hash_ci,
	.d_compare	= sdcardfskk_cmp_ci,
};
